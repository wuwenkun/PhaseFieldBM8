...
//registerMooseObject("nucleation_bm", DiscreteNucleationTanh);

template <>
InputParameters
validParams<DiscreteNucleationTanh>()
{
...
DiscreteNucleationTanh::DiscreteNucleationTanh(const InputParameters & params)
...
void
DiscreteNucleationTanh::computeProperties()
{
