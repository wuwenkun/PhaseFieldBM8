...
[BCs]
  [./eta_bottom]
    ...
    boundary = 'bottom'
  [../]
  # The default zero-normal derivative Neumann 
  # boundary conditions are applied to the other sides.
[]
...
[Materials]
  [./f_eta]
    ...
    w = 1.0
    deltafT = 0.02310 # 1/(30*sqrt(2)) * 0.98 # modify \Delta f here
  [../]
  [./constants]
