...
// Forward declaration
class DiscreteNucleationTanh;
class DiscreteNucleationMapTanh;

template <>
InputParameters validParams<DiscreteNucleationTanh>();

/**
 * Free energy penalty contribution to force the nucleation of subresolution particles
 */
class DiscreteNucleationTanh : public DerivativeFunctionMaterialBase
{
public:
  DiscreteNucleationTanh(const InputParameters & params);
