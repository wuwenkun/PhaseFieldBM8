...
class DiscreteNucleationMarkerTanh;
class DiscreteNucleationMapTanh;

template <>
InputParameters validParams<DiscreteNucleationMarkerTanh>();

/**
 * Mark new nucleation sites for refinement
 */
class DiscreteNucleationMarkerTanh : public Marker
{
public:
  DiscreteNucleationMarkerTanh(const InputParameters & parameters);

protected:
  virtual MarkerValue computeElementMarker() override;

  /// UserObject providing a map of currently active nuclei
  const DiscreteNucleationMapTanh & _map;
