...
template <>
InputParameters validParams<DiscreteNucleationMapTanh>();
 ...
 */
class DiscreteNucleationMapTanh : public ElementUserObject
{
public:
  DiscreteNucleationMapTanh(const InputParameters & parameters);
...
protected:
  ...
  /// list of nuclei maintained by the inserter object
